...
TO DO:
 ...
 [ ] Salvar e carregar planilha
     [ ] Qual a jornada de quem vai usar? (passo a passo)
     [ ] Estruturar melhor como queremos acessar esses dados
     [ ] O que gravar?
     [ ] O que vamos ler?
     [ ] Jeito rápido de gravar (picle)
     [ ] Ler lista com nomes de ambientes
